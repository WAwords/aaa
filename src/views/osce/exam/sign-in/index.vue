  ...
  <div class="router-page">
    ...
    >
      <template #query-form>
        ...
        <el-form-item prop="signIn" label="范围">
          <el-select
      ...
      <el-table-column label="操作" fixed="right" width="90px" align="center">
        <template #default="{ row }">
          <el-button
            ...
            v-if="!row.signIn"
            class="w-full"
            v-hasPermi="['osce:examination:sign-in']"
            text
          >
            签到
          </el-button>
...
import {
  getExamineeListApi,
  patchExamineeSignInApi,
} from "@/api/osce/exam/management";

defineOptions({
  name: "OsceExamSign-in",
});
